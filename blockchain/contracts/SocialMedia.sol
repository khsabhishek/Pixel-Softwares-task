...
contract SocialMedia {
    ...
    mapping(uint32 => Post) public allPostsData;
    ...
    event NewPost(uint32 indexed postId, string content, string ipfsHash, address user);
    ...
    function addPost(string memory _content, string memory _ipfsHash) public {
        ...
        postCount++;
        allPostsData[postCount] = Post(_content, _ipfsHash);
